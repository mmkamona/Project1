...
describe('signup with correct info', () => {
    it('signup test', function () {
        ...
        cy.get('#company_email_address').type('mohamed.mostafa39@candidate.manatal.com')
        cy.get('#confirm_company_email_address').type('mohamed.mostafa39@candidate.manatal.com')
        ...
        //confirming new account creation
        cy.get('.mt-4')
            .should('contain', 'Confirm your e-mail address')
